...
// @Entity(name="name_of_table") <- Do this to map this class to table with diff name.  
@Entity // In this case, name of class and table is same. So no need to specify name.
public class course {
	@Id
	private int id;
	@Column // Similar to above, we dont have to specify @Column if variable name and name in table column matches.
	private String name;
