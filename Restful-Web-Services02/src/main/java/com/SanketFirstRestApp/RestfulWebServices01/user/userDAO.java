...
public class userDAO { // This is where actions related to user data/database will happen. In methods.
	...
	public user findSpecifcUser(String name){
		Predicate<? super user> predicate= User-> User.getName().equals(name); // For some reason the equals dont work with id. As it is primitive.
