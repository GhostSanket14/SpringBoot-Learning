	...
	<div class="container"> <!-- Now we are using bootstrap classes -->
		...
		<form:form method="post" modelAttribute="TodoModAt"> <!-- we bind our bean to this form using model attribute (i have indicated it with -*- in the code) -->
		<fieldset class="mb-4">
			<form:label path="description">Description</form:label>
			<form:input type="text" path="description" required="required" /> <!-- TO make input compulsory, make it required -->
			<!-- Above we marked form:input "path="description" to variable description in modelAttribute Todo -->					 
